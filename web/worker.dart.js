...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    PrimitiveResponsePayload: function PrimitiveResponsePayload(t0) {
      this.message = t0;
    },
    ...
    WebProtocol: function WebProtocol(t0) {
      this._protocolVersion = t0;
    },
    ...
    _BaseExecutor__synchronized_closure: function _BaseExecutor__synchronized_closure(t0, t1, t2) {
      this.abortIfCancelled = t0;
      this.action = t1;
      this.T = t2;
    },
    ...
    Lock_synchronized_callBlockAndComplete: function Lock_synchronized_callBlockAndComplete(t0, t1, t2, t3, t4) {
      var _ = this;
      _.$this = t0;
      _.block = t1;
      _.blockCompleted = t2;
      _.blockReleasedLock = t3;
      _.T = t4;
    },
    Lock_synchronized_callBlockAndComplete_closure: function Lock_synchronized_callBlockAndComplete_closure(t0, t1, t2) {
      this.$this = t0;
      this.blockCompleted = t1;
      this.blockReleasedLock = t2;
    },
    Lock_synchronized_closure: function Lock_synchronized_closure(t0, t1) {
      this.callBlockAndComplete = t0;
      this.T = t1;
    },
    WebPortToChannel_channel(_this) {
      var protocol, _null = null,
        _s8_ = "_foreign",
      ...
      protocol = new A.WebProtocol(A.ProtocolVersion_negotiate(0));
      _this.onmessage = A._functionToJS1(new A.WebPortToChannel_channel_closure(false, controller, false, protocol));
      ...
      new A._ControllerStream(t1, A._instanceType(t1)._eval$1("_ControllerStream<1>")).listen$2$onDone(new A.WebPortToChannel_channel_closure0(false, protocol, _this), new A.WebPortToChannel_channel_closure1(false, _this));
      t1 = controller.__StreamChannelController__foreign_F;
      t1 === $ && A.throwLateFieldNI(_s8_);
      return t1;
    },
    WebPortToChannel_channel_closure: function WebPortToChannel_channel_closure(t0, t1, t2, t3) {
      var _ = this;
      _.explicitClose = t0;
      _.controller = t1;
      _.webNativeSerialization = t2;
      _.protocol = t3;
    },
    WebPortToChannel_channel_closure0: function WebPortToChannel_channel_closure0(t0, t1, t2) {
      this.webNativeSerialization = t0;
      this.protocol = t1;
      this._this = t2;
    },
    ...
    initSqlJs() {
      ...
      if (!("initSqlJs" in t2))
        ...
        completer.complete$1(0, A.promiseToFuture(t1._as(t2.initSqlJs()), t1).then$1$1(A.sql_js_SqlJsModule_____tearOff$closure(), type$.SqlJsModule));
      return $._moduleCompleter.future;
    },
    SqlJsModule_____tearOff(_obj) {
      return new A.SqlJsModule(type$.JSObject._as(_obj));
    },
    _replaceDartBigInts(dartList) {
      var t2, t3, _i, arg, t4, t1 = [];
      for (t2 = dartList.length, t3 = type$.JavaScriptBigInt, _i = 0; _i < dartList.length; dartList.length === t2 || (0, A.throwConcurrentModificationError)(dartList), ++_i) {
        arg = dartList[_i];
        if (arg instanceof A._BigIntImpl) {
          ...
          t1.push(t3._as(t4.BigInt(arg.toString$0(0))));
        } else
          t1.push(A.jsify(arg));
      }
      return t1;
    ...
    PreparedStatement_columnNames_closure: function PreparedStatement_columnNames_closure() {
    },
    ...
    _IndexedDbStorage_open_closure: function _IndexedDbStorage_open_closure(t0, t1) {
      this._box_0 = t0;
      this.openRequest = t1;
    },
    ProtocolVersion_negotiate(versionCode) {
      ...
      $label0$0: {
        if (versionCode <= 0) {
          t1 = B.ProtocolVersion_0_0_legacy;
          break $label0$0;
        }
        if (1 === versionCode) {
          t1 = B.ProtocolVersion_1_1_v1;
          break $label0$0;
        }
        if (2 === versionCode) {
          t1 = B.ProtocolVersion_2_2_v2;
          break $label0$0;
        }
        if (3 === versionCode) {
          t1 = B.ProtocolVersion_3_3_v3;
          break $label0$0;
        }
        if (versionCode > 3) {
          t1 = B.ProtocolVersion_4_4_v4;
          break $label0$0;
        }
    ...
    ProtocolVersion: function ProtocolVersion(t0, t1, t2) {
      this.versionCode = t0;
      this.index = t1;
      this._name = t2;
    },
    CompleteIdbRequest_complete(_this, $T) {
      ...
      A._EventStreamSubscription$(_this, "blocked", t2._as(new A.CompleteIdbRequest_complete_closure1(completer, _this)), false, t3);
      return t1;
    },
    ...
    CompleteIdbRequest_complete_closure1: function CompleteIdbRequest_complete_closure1(t0, t1) {
      this.completer = t0;
      this._this = t1;
    },
    ...
    main() {
      var t1, $self, t2, worker;
      self.importScripts("sql-wasm.js");
      t1 = new A.main_closure();
      $self = type$.JSObject._as(self);
      t2 = A.JSAnyUtilityExtension_instanceOfString($self, "SharedWorkerGlobalScope");
      if (t2)
        worker = new A._RunningDriftWorker(true, t1);
      else {
        t2 = A.JSAnyUtilityExtension_instanceOfString($self, "DedicatedWorkerGlobalScope");
        if (t2)
  ...
  A.DriftCommunication.prototype = {
    ...
    setRequestHandler$1(handler) {
      ...
      new A._ControllerStream(t1, A._instanceType(t1)._eval$1("_ControllerStream<1>")).listen$1(new A.DriftCommunication_setRequestHandler_closure(this, type$.FutureOr_nullable_ResponsePayload_Function_Request._as(handler)));
    }
  };
  A.DriftCommunication_closure.prototype = {
    call$0() {
      var t1, t2, t3, t4, t5;
      for (t1 = this.$this, t2 = t1._pendingRequests, t3 = t2.get$values(0), t4 = A._instanceType(t3), t3 = new A.MappedIterator(J.get$iterator$ax(t3.__internal$_iterable), t3._f, t4._eval$1("MappedIterator<1,2>")), t4 = t4._rest[1]; t3.moveNext$0();) {
      ...
      if (t2.__js_helper$_length > 0) {
        t2._strings = t2._nums = t2.__js_helper$_rest = t2._first = t2._last = null;
  ...
  A.DriftCommunication_setRequestHandler_closure.prototype = {
    ...
    $call$body$DriftCommunication_setRequestHandler_closure(request) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, e, s, t1, t2, exception, response, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.nullable_ResponsePayload;
              $async$goto = 7;
              return A._asyncAwait(type$.Future_nullable_ResponsePayload._is(t1) ? t1 : A._Future$value(t2._as(t1), t2), $async$call$1);
            case 7:
              // returning from await.
            ...
            case 6:
              ...
              if (!(t1._startedClosingLocally || (t1._closeCompleter.future._state & 30) !== 0)) {
                t2 = type$.nullable_ResponsePayload._as(response);
  ...
  A.DriftProtocol.prototype = {
    ...
    deserialize$1(message) {
      ...
      tag = A._asInt(t1.$index(message, 0));
      id = A._asInt(t1.$index(message, 1));
      switch (tag) {
        case 0:
          return new A.Request(id, type$.nullable_RequestPayload._as(this.decodePayload$1(t1.$index(message, 2))));
        case 2:
        ...
        case 1:
          return new A.SuccessResponse(id, type$.nullable_ResponsePayload._as(this.decodePayload$1(t1.$index(message, 2))));
        case 3:
    ...
    encodePayload$1(payload) {
      var t1, t2, t3, t4, t5, _i, arg, t6, _i0, update, rows, result, columns, _0_0;
      if (payload == null)
        return payload;
      ...
      else if (payload instanceof A.PrimitiveResponsePayload) {
        _0_0 = payload.message;
        $label0$0: {
          if (A._isBool(_0_0)) {
            t1 = _0_0;
            break $label0$0;
          ...
          if (A._isInt(_0_0)) {
            t1 = A._setArrayType([10, _0_0], type$.JSArray_int);
            break $label0$0;
          }
          t1 = A.throwExpression(A.UnsupportedError$("Unknown primitive response"));
        }
        return t1;
      }
    },
    decodePayload$1(encoded) {
      var t1, tag, readInt, readNullableInt, method, sql, t2, args, i, list, t3, t4, t5, _1_0, updates, encodedUpdate, _2_0, columnCount, columns, rows, result, t6, rowOffset, t7, c, _null = null, _box_0 = {};
      if (encoded == null)
        return _null;
      if (A._isBool(encoded))
        return new A.PrimitiveResponsePayload(encoded);
      ...
      switch (tag) {
        ...
        case 4:
          ...
          _1_0 = J.get$last$ax(_box_0.fullMessage);
          $label1$2: {
            if (_1_0 == null) {
              t1 = _null;
              break $label1$2;
          ...
          return new A.ExecuteBatchedStatement(new A.BatchedStatements(sql, args), t1);
        case 5:
        ...
        case 10:
          return new A.PrimitiveResponsePayload(A._asInt(J.$index$asx(encoded, 1)));
      }
  ...
  A.DriftProtocol_decodePayload_readNullableInt.prototype = {
    call$1(index) {
      var _0_0,
        t1 = this._box_0.fullMessage;
      t1.toString;
      _0_0 = J.$index$asx(t1, index);
      $label0$0: {
        if (_0_0 == null) {
          t1 = null;
          break $label0$0;
  ...
  A.PrimitiveResponsePayload.prototype = {$isResponsePayload: 1};
  ...
  A.ExecuteBatchedStatement.prototype = {$isRequestPayload: 1};
  ...
  A.SelectResult.prototype = {$isResponsePayload: 1};
  A.ServerImplementation.prototype = {
    ...
    serve$1(channel) {
      ...
      return comm._closeCompleter.future.then$1$1(new A.ServerImplementation_serve_closure0(_this, comm), type$.void);
    },
    ...
    _handleRequest$2(comms, request) {
      ...
      if (payload instanceof A.NoArgsRequest)
        ...
        token = A.runCancellable(new A.ServerImplementation__handleRequest_closure(_this, payload), type$.nullable_ResponsePayload);
    ...
    _handleEnsureOpen$2(comms, $open) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.ResponsePayload),
      ...
      var $async$_handleEnsureOpen$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 4:
              // returning from await.
              $async$returnValue = new $async$temp1.PrimitiveResponsePayload($async$result);
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    _runQuery$4(method, sql, args, transactionId) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.nullable_ResponsePayload),
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 7:
              // case
              $async$goto = 11;
              return A._asyncAwait(executor.runCustom$2(sql, args), $async$_runQuery$4);
            case 11:
              // returning from await.
            ...
            case 8:
              ...
              $async$temp1 = A;
              $async$goto = 12;
              return A._asyncAwait(executor.runDelete$2(sql, args), $async$_runQuery$4);
            case 12:
              // returning from await.
              $async$returnValue = new $async$temp1.PrimitiveResponsePayload($async$result);
              // goto return
            ...
            case 9:
              ...
              $async$temp1 = A;
              $async$goto = 13;
              return A._asyncAwait(executor.runInsert$2(sql, args), $async$_runQuery$4);
            case 13:
              // returning from await.
              $async$returnValue = new $async$temp1.PrimitiveResponsePayload($async$result);
              // goto return
    ...
    _spawnTransaction$2(comm, executor) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, t1, transaction;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              // returning from await.
              t1 = $async$result;
              transaction = t1.beginTransactionInContext$1(t1);
              $async$goto = 4;
            ...
            case 4:
              // returning from await.
              $async$returnValue = $async$self._putExecutor$2$beforeCurrent(transaction, true);
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    _spawnExclusive$2(comm, executor) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.int),
        $async$returnValue, $async$self = this, exclusive, $async$temp1;
      var $async$_spawnExclusive$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              // returning from await.
              exclusive = new $async$temp1._ExclusiveExecutor($async$result, new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void), new A.Lock());
              $async$goto = 4;
            ...
            case 4:
              // returning from await.
              $async$returnValue = $async$self._putExecutor$2$beforeCurrent(exclusive, true);
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    _transactionControl$body$ServerImplementation(comm, action, executorId) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.nullable_ResponsePayload),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, executor, $async$temp1;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 11:
              // then
              $async$goto = 13;
              return A._asyncAwait(J.close$0$z(executor), $async$_transactionControl$3);
            case 13:
              // returning from await.
              executorId.toString;
  ...
  A._BaseExecutor.prototype = {
    ...
    _synchronized$1$2$abortIfCancelled(action, abortIfCancelled, $T) {
      $T._eval$1("Future<0>()")._as(action);
      if (this.get$isSequential() || this._waitingChildExecutors > 0)
        return this._lock.synchronized$1$1(new A._BaseExecutor__synchronized_closure(abortIfCancelled, action, $T), $T);
      else
        return action.call$0();
    },
    _synchronized$1$1(action, $T) {
      return this._synchronized$1$2$abortIfCancelled(action, true, $T);
    },
    _log$2(sql, args) {
  ...
  A._BaseExecutor__synchronized_closure.prototype = {
    call$0() {
      return this.$call$body$_BaseExecutor__synchronized_closure(this.T);
    },
    $call$body$_BaseExecutor__synchronized_closure($async$type) {
      var $async$goto = 0,
      ...
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              if ($async$self.abortIfCancelled)
                A.checkIfCancelled();
              $async$goto = 3;
              return A._asyncAwait($async$self.action.call$0(), $async$call$0);
            case 3:
              // returning from await.
  ...
  A._StatementBasedTransactionExecutor.prototype = {
    ensureOpen$1(user) {
      ...
      if (opened == null) {
        ...
        $parent._synchronized$1$2$abortIfCancelled(new A._StatementBasedTransactionExecutor_ensureOpen_closure(_this), false, type$.Null).whenComplete$1(new A._StatementBasedTransactionExecutor_ensureOpen_closure0($parent));
      }
    ...
    beginTransactionInContext$1(context) {
      var t1 = this.depth + 1;
      return new A._StatementBasedTransactionExecutor(this._engines$_delegate, new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void), context, t1, A._defaultSavepoint(t1), A.delegates___defaultRelease$closure().call$1(t1), A._defaultRollbackToSavepoint(t1), this._db, new A.Lock());
    },
    send$0(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              s = A.getTraceFromException($async$exception);
              t1 = $async$self.$this;
              t1._opened.completeError$2(e, s);
              t1._release$0();
              // goto after finally
              $async$goto = 5;
              break;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $async$self.$this;
              if (t1._closed) {
                _0_0 = A._interceptUserError(new A.StateError("Can't re-open a database after closing it. Please create a new database connection and open that instead."), null);
  ...
  A._ExclusiveExecutor.prototype = {
    get$dialect() {
      return this._outer.get$dialect();
    },
    ensureOpen$1(user) {
  ...
  A.Lock.prototype = {
    synchronized$1$1(block, $T) {
      ...
      t1 = new A.Lock_synchronized_callBlockAndComplete(this, block, new A._AsyncCompleter(t1, type$._AsyncCompleter_void), t1, $T);
      if (previous != null)
  ...
  A.Lock_synchronized_callBlockAndComplete.prototype = {
    call$0() {
      var _this = this;
      return A.Future_Future$sync(_this.block, _this.T).whenComplete$1(new A.Lock_synchronized_callBlockAndComplete_closure(_this.$this, _this.blockCompleted, _this.blockReleasedLock));
    },
    $signature() {
      return this.T._eval$1("Future<0>()");
    }
  };
  A.Lock_synchronized_callBlockAndComplete_closure.prototype = {
    call$0() {
      this.blockCompleted.complete$0(0);
      var t1 = this.$this;
  ...
  A.SqlJsModule.prototype = {
    _createInternally$1(data) {
      var t1 = type$.JavaScriptFunction,
        ...
        t3 = this._obj;
      if (data != null)
        return A.JSFunctionUnsafeUtilExtension_callAsConstructor(t1._as(t3.Database), data, t2);
      else
        return A.JSFunctionUnsafeUtilExtension_callAsConstructor(t1._as(t3.Database), null, t2);
    }
  };
  A.SqlJsDatabase.prototype = {
    runWithArgs$2(sql, args) {
      ...
      if (args.length === 0)
        ...
        t1.run(sql, A._replaceDartBigInts(args));
    },
    _selectSingleRowAndColumn$1(sql) {
      var t1 = type$.JSArray_nullable_Object,
        results = t1._as(this._obj.exec(sql));
      t1 = t1._as(J.get$first$ax(type$.List_JSObject._is(results) ? results : new A.CastList(results, A._arrayInstanceType(results)._eval$1("CastList<1,JSObject>"))).values);
      t1 = J.get$first$ax(type$.List_JSArray_nullable_Object._is(t1) ? t1 : new A.CastList(t1, A._arrayInstanceType(t1)._eval$1("CastList<1,JSArray<Object?>>")));
      return A.dartify(B.JSArray_methods.get$first(t1));
    }
  };
  A.PreparedStatement.prototype = {
    currentRow$1(useBigInt) {
      return type$.List_dynamic._as(A.dartify(type$.JSArray_nullable_Object._as(this._obj.get(null, null))));
    },
    columnNames$0() {
      var t1 = type$.JSArray_nullable_Object._as(this._obj.getColumnNames());
      t1 = type$.List_String._is(t1) ? t1 : new A.CastList(t1, A._arrayInstanceType(t1)._eval$1("CastList<1,String>"));
      t1 = J.map$1$1$ax(t1, new A.PreparedStatement_columnNames_closure(), type$.String);
      return A.List_List$of(t1, true, t1.$ti._eval$1("ListIterable.E"));
    }
  };
  A.PreparedStatement_columnNames_closure.prototype = {
    call$1(e) {
  ...
  A._IndexedDbStorage.prototype = {
    ...
    open$body$_IndexedDbStorage(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t2, openRequest, t1, $async$temp1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1.wasCreated = false;
              t2 = type$.JSObject;
              openRequest = t2._as(t2._as(t2._as(self).indexedDB).open("moor_databases", 1));
              openRequest.onupgradeneeded = A._functionToJS1(new A._IndexedDbStorage_open_closure(t1, openRequest));
              $async$temp1 = t2;
              $async$goto = 2;
              return A._asyncAwait(A.CompleteIdbRequest_complete(openRequest, t2), $async$open$0);
            case 2:
              // returning from await.
    ...
    store$1(_, data) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t2, transaction, t1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 === $ && A.throwLateFieldNI("_database");
              t2 = type$.JSObject;
              transaction = t2._as(t1.transaction("moor_databases", "readwrite"));
              $async$goto = 2;
              return A._asyncAwait(A.CompleteIdbRequest_complete(t2._as(t2._as(transaction.objectStore("moor_databases")).put(t2._as(new self.Blob(A._setArrayType([data], type$.JSArray_NativeUint8List))), $async$self.name)), type$.nullable_Object), $async$store$1);
            case 2:
              // returning from await.
              $async$goto = 3;
              return A._asyncAwait(new A._EventStream(transaction, "complete", false, type$._EventStream_JSObject).get$first(0), $async$store$1);
            case 3:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
    ...
    restore$0(_) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, t2, result, reader, t1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.JSObject;
              $async$goto = 3;
              return A._asyncAwait(A.CompleteIdbRequest_complete(t2._as(t2._as(t2._as(t1.transaction("moor_databases", "readonly")).objectStore("moor_databases")).get($async$self.name)), type$.nullable_JSObject), $async$restore$0);
            case 3:
              // returning from await.
              result = $async$result;
              if (result == null) {
              ...
              reader = t2._as(new self.FileReader());
              reader.readAsArrayBuffer(result);
              $async$goto = 4;
              return A._asyncAwait(new A._EventStream(reader, "load", false, type$._EventStream_JSObject).get$first(0), $async$restore$0);
            case 4:
              // returning from await.
              $async$returnValue = A.NativeUint8List_NativeUint8List$view(type$.NativeByteBuffer._as(reader.result), 0, null);
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  A._IndexedDbStorage_open_closure.prototype = {
    call$1($event) {
      ...
      t1._as($event);
      t1._as(t1._as(this.openRequest.result).createObjectStore("moor_databases"));
  ...
  A.ProtocolVersion.prototype = {
    _enumToString$0() {
      return "ProtocolVersion." + this._name;
    }
  };
  A.CompleteIdbRequest_complete_closure.prototype = {
    call$1($event) {
      this.completer.complete$1(0, this.T._as(this._this.result));
    },
    $signature: 5
  };
  ...
  A._WebDelegate.prototype = {
    ...
    runBatched$1(statements) {
      ...
      for (t2 = J.get$iterator$ax(statements.statements), t3 = type$.JSObject; t2.moveNext$0();) {
        t4 = t2.get$current(t2);
        t5 = this.___WebDelegate__db_A;
        t5 === $ && A.throwLateFieldNI("_db");
        t1.push(new A.PreparedStatement(t3._as(t5._obj.prepare(t4))));
      }
      for (t2 = statements.$arguments, t3 = t2.length, _i = 0; _i < t2.length; t2.length === t3 || (0, A.throwConcurrentModificationError)(t2), ++_i) {
        ...
        t4 = t1[t4]._obj;
        t4.bind(A._replaceDartBigInts(application.$arguments));
        A._asBool(t4.step());
      }
    ...
    runSelect$2(statement, args) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, stmt, rows, columnNames, t1;
      var $async$runSelect$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $async$self.___WebDelegate__db_A;
              t1 === $ && A.throwLateFieldNI("_db");
              t1 = type$.JSObject._as(t1._obj.prepare(statement));
              stmt = new A.PreparedStatement(t1);
              t1.bind(A._replaceDartBigInts(args));
              rows = A._setArrayType([], type$.JSArray_List_dynamic);
              for (columnNames = null; A._asBool(t1.step());) {
                if (columnNames == null)
    ...
    _handlePotentialUpdate$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.int),
        $async$returnValue, $async$self = this, modified, t1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $async$self.___WebDelegate__db_A;
              t1 === $ && A.throwLateFieldNI("_db");
              modified = A._asInt(t1._obj.getRowsModified());
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              t1 === $ && A.throwLateFieldNI("_db");
              $async$goto = 4;
              return A._asyncAwait($async$self.storage.store$1(0, type$.NativeUint8List._as(t1._obj.export())), $async$_storeDb$0);
            case 4:
              // returning from await.
            case 3:
              // join
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $async$self.delegate.___WebDelegate__db_A;
              t1 === $ && A.throwLateFieldNI("_db");
              t1._obj.run("PRAGMA user_version = " + version);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  A._RunningDriftWorker.prototype = {
    start$0(_) {
      ...
      if (this.isShared)
        A._EventStreamSubscription$(t1._as(self), "connect", type$.nullable_void_Function_JSObject._as(this.get$_newConnection()), false, t1);
      else {
        t1 = t1._as(self);
        new A._MapStream(t2._eval$1("Object?(Stream.T)")._as(new A._RunningDriftWorker_start_closure()), new A._EventStream(t1, "message", false, t2), t2._eval$1("_MapStream<Stream.T,Object?>")).listen$1(this.get$_handleMessage());
      }
    },
    ...
    _newConnection$1($event) {
      var t1 = {},
        ...
        outgoingPort = J.get$first$ax(type$.List_JSObject._is(t2) ? t2 : new A.CastList(t2, A._arrayInstanceType(t2)._eval$1("CastList<1,JSObject>"))),
        originalChannel = A.WebPortToChannel_channel(outgoingPort);
      ...
      var $async$_handleMessage$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              if (message != null && A.JSAnyUtilityExtension_instanceOfString(message, "MessagePort")) {
                server = $async$self._startedServer;
                if (server == null)
                  server = $async$self._establishModeAndLaunchServer$1(B.DriftWorkerMode_0);
                server.serve$1(A.WebPortToChannel_channel(type$.JSObject._as(message)));
              } else
  ...
  A._RunningDriftWorker_start_closure.prototype = {
    call$1(e) {
      return type$.JSObject._as(e).data;
    },
    $signature: 47
  };
  ...
  A._RunningDriftWorker__newConnection_closure.prototype = {
    call$1(first) {
      var server, worker, _this = this, _s5_ = "_sink",
        expectedMode = A.EnumByName_byName(B.List_gjJ, A._asString(first), type$.DriftWorkerMode),
        t1 = _this.$this,
        t2 = t1._knownMode;
      if (t2 == null)
        switch (expectedMode.index) {
          ...
          case 2:
            ...
            worker = type$.JSObject._as(new self.Worker(A.Uri_base().toString$0(0)));
            t1.set$_dedicatedWorker(worker);
            t1 = _this.outgoingPort;
            t1.postMessage(true);
            worker.postMessage(t1, A._setArrayType([t1], type$.JSArray_JSObject));
            t1 = _this.originalChannel.__GuaranteeChannel__sink_F;
            t1 === $ && A.throwLateFieldNI(_s5_);
            t1.close$0(0);
            break;
        ...
        switch (t1._knownMode.index) {
          ...
          case 2:
            ...
            t1.toString;
            t1.postMessage(t2, A._setArrayType([t2], type$.JSArray_JSObject));
  ...
  A.main_closure.prototype = {
    call$0() {
      return new A.WebDatabase(new A._WebDelegate(new A._IndexedDbStorage("worker", false), null, null, false), false, true, new A.Lock(), new A.Lock());
    },
    $signature: 60
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 62, 0);
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 65, 0);
    ...
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 70, 0);
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 71, 0);
    _static(A, "async___rootCreatePeriodicTimer$closure", 5, null, ["call$5"], ["_rootCreatePeriodicTimer"], 72, 0);
    _static(A, "async___rootPrint$closure", 4, null, ["call$4"], ["_rootPrint"], 73, 0);
    _static_1(A, "async___printToZone$closure", "_printToZone", 74);
    ...
    _instance(_, "get$addError", 0, 1, null, ["call$2", "call$1"], ["addError$2", "addError$1"], 79, 0, 0);
    ...
    _instance_2_u(_, "get$_handleError", "_handleError$2", 31);
    ...
    _instance_1_u(A.DriftProtocol.prototype, "get$_decodeDbValue", "_decodeDbValue$1", 12);
    _static_1(A, "delegates___defaultSavepoint$closure", "_defaultSavepoint", 14);
    _static_1(A, "delegates___defaultRelease$closure", "_defaultRelease", 14);
    _static_1(A, "delegates___defaultRollbackToSavepoint$closure", "_defaultRollbackToSavepoint", 14);
    _static_1(A, "sql_js_SqlJsModule_____tearOff$closure", "SqlJsModule_____tearOff", 77);
    _instance_1_u(_ = A._RunningDriftWorker.prototype, "get$_newConnection", "_newConnection$1", 5);
    _instance_1_u(_, "get$_handleMessage", "_handleMessage$1", 4);
    ...
    _static_1(A, "trace_Trace___parseVM_tearOff$closure", "Trace___parseVM_tearOff", 15);
    _static_1(A, "trace_Trace___parseFriendly_tearOff$closure", "Trace___parseFriendly_tearOff", 15);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Iterable, [A._CastIterableBase, A.EfficientLengthIterable, A.MappedIterable, A.WhereIterable, A.ExpandIterable, A.TakeIterable, A.SkipIterable, A.SkipWhileIterable, A.WhereTypeIterable, A._AllMatchesIterable, A._StringAllMatchesIterable]);
    ...
    _inheritMany(A.Stream, [A._StreamImpl, A._ForwardingStream, A.SubscriptionStream, A._CloseGuaranteeStream, A._EventStream]);
    ...
    _inheritMany(A._Enum, [A.NoArgsRequest, A.StatementMethod, A.NestedExecutorControl, A.UpdateKind, A.SqlDialect, A.ProtocolVersion, A.DriftWorkerMode]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "~(String,@)", "Null()", "~(Object?)", "~(JSObject)", "Frame()", "~(@)", "Future<~>()", "Frame(String)", "~(Object,StackTrace)", "String(String)", "Object?(Object?)", "~(~())", "String(int)", "Trace(String)", "Null(@)", "Null(@,StackTrace)", "Future<int>()", "bool()", "@()", "int(int,int)", "int(int)", "~(Uint8List,String,int)", "~(String,String)", "bool(~)", "Future<Null>()", "Null(JSObject)", "int(Frame)", "String(Frame)", "Uint8List(@,@)", "~(@,StackTrace)", "Future<~>(Request)", "int?(int)", "Null(~)", "ResponsePayload?/(Request)", "~(@,@)", "Future<ResponsePayload?>()", "CancellationToken<@>?()", "Future<QueryResult>()", "_Future<@>(@)", "~(Object?,Object?)", "int()", "Future<bool>()", "Map<String,@>(List<Object?>)", "~(int,@)", "@(@,String)", "Object?(JSObject)", "StreamChannel<Object?>()", "SubscriptionStream<Object?>(Stream<Object?>)", "Null(Object,StackTrace)", "String(String?)", "List<Frame>(Trace)", "0^(0^,0^)<num>", "~(String,int)", "String(Trace)", "~(String,int?)", "@(String)", "Frame(String,String)", "Trace()", "WebDatabase()", "@(@)", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "~(String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "Null(bool)", "SqlJsModule(JSObject)", "Null(~())", "~(Object[StackTrace?])", "int(Trace)"],
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      FutureOr_nullable_ResponsePayload_Function_Request: findType("ResponsePayload?/(Request)"),
      Future_dynamic: findType("Future<@>"),
      Future_nullable_ResponsePayload: findType("Future<ResponsePayload?>"),
      ...
      List_JSArray_nullable_Object: findType("List<JSArray<Object?>>"),
      ...
      ResponsePayload: findType("ResponsePayload"),
      ...
      nullable_RequestPayload: findType("RequestPayload?"),
      nullable_ResponsePayload: findType("ResponsePayload?"),
...
;
    ...
    B.List_gjJ = A._setArrayType(makeConstList([B.DriftWorkerMode_0, B.DriftWorkerMode_1, B.DriftWorkerMode_2]), A.findType("JSArray<DriftWorkerMode>"));
    ...
    B.ProtocolVersion_0_0_legacy = new A.ProtocolVersion(0, 0, "legacy");
    B.ProtocolVersion_1_1_v1 = new A.ProtocolVersion(1, 1, "v1");
    B.ProtocolVersion_2_2_v2 = new A.ProtocolVersion(2, 2, "v2");
    B.ProtocolVersion_3_3_v3 = new A.ProtocolVersion(3, 3, "v3");
    B.ProtocolVersion_4_4_v4 = new A.ProtocolVersion(4, 4, "v4");
